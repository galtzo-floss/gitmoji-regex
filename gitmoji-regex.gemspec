...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/gitmoji/regex/version.rb", mod) }::Gitmoji::Regex::Version::VERSION
  else
    require_relative "lib/gitmoji/regex/version"
    Gitmoji::Regex::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency("json", "~> 2.7", ">= 2.7.6")                 # ruby >= 2.3; later v2 minors need ruby >= 2.7, so Bundler picks per Ruby
